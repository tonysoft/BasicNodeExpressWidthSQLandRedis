...
INSERT INTO users (username, email, phone_numbers, dummy, timestamp)
VALUES ('tonysoft', {'work': 'tony@iRelate.us', 'personal': 'tony.sukiennik@gmail.com'}, {6032244208, 6037319375}, 0, now());
...
UPDATE users SET sports = sports + {'golf'} WHERE username = 'tonysoft' and timestamp = 470d8390-679a-11e4-9f25-091a5ef02cdc;
